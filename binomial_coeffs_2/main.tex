...
Let $n,j \in \Z_{>-1}$ such that $j \leq n$. Then
\begin{align*}
1 + \left( \floor{ \frac{(2^n+1)^n - 1}{2^{nj}(1-2^n)} } \bmod 2^n \right) = \sum_{k=0}^{j} \binom{n}{k}
\end{align*}
\end{theorem}
\begin{proof}
