...
\end{align*}
However, this contradicts the assumption in the theorem that $n$ does not have a prime factor less than $4r$. Similarly, suppose we are given $p$ such that $2r \leq p < 4r$. Then, $x^p$ can be itself when reduced mod $((x^r-2)(x-\alpha)^r,p)$, allowing for
\begin{align*}
