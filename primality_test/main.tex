...
\begin{align*}
    ...
    \quad \Longleftrightarrow \quad
    \floor{n/r} \equiv 0 \pmod{\ord_n 2} ,
\end{align*}
where $\ord_n 2$ is the multiplicative order of $2$ modulo $n$. However, since $n$ is a Carmichael number, this is impossible, since $\ord_2 n \mid (n-1)$, and $r \nmid (n-1)$.
