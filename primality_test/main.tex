...
\end{lemma}
\begin{proof}
If $n > 6$ is an integer, by the Prime Number Theorem, it must have fewer than $\log n$ distinct prime factors. Hence, we need to establish an upper bound on the $\log n$-th prime number.
