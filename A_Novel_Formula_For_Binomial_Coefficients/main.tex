...
\begin{align}
P(x,D)^n = \left(\frac{x^{D}-1}{x-1}\right)^n = (1 + x + \ldots + x^{D-1})^n
\end{align}
...
\end{equation}
Finally, we replace the values of $P(1,D)^n$ and $P(P(1,D)^n,D)^n$ and simplify to arrive at our original equation:
\begin{align}
